...
import pom.pages.SelectableDemo;
...
public class Selectable extends BaseTest {
    ...
    public void testElectricalPermit() {
        ...
        SelectableDemo SelectableDemo = new SelectableDemo(driver, test);
        PageFactory.initElements(driver, SelectableDemo);
        
        test.log(Status.INFO, "Selenium Using Java");
        SelectableDemo.RedirectToSelectable();
        SelectableDemo.Selections();
