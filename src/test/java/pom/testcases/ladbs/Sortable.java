...
public class Sortable extends BaseTest {
    ...
    public void testElectricalPermit() {
        ...
        SortableDemo SortableDemo = new SortableDemo(driver, test);
        PageFactory.initElements(driver, SortableDemo);
        
        test.log(Status.INFO, "Selenium Using Java");
        SortableDemo.RedirectToSortable();
        SortableDemo.Sortable();
	}
