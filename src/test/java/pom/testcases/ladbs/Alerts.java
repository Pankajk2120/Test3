...
public class Alerts extends BaseTest {
    ...
    public void testElectricalPermit() {
        ...
        AlertDemo.RedirectToAlerts();
        //AlertDemo.ClickingOnAlert1();
        //AlertDemo.ClickingOnAlert2();
        //AlertDemo.ClickingOnAlert3();
        AlertDemo.ClickingOnAlert4();
