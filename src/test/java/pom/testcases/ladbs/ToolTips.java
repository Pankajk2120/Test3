...
public class ToolTips extends BaseTest {
    ...
    public void testElectricalPermit() {
        ...
        ToolTipsDemo ToolTipsDemo = new ToolTipsDemo(driver, test);
        PageFactory.initElements(driver, ToolTipsDemo);

        test.log(Status.INFO, "Selenium Using Java");
        ToolTipsDemo.RedirectToToolTips();
        ToolTipsDemo.TooltiponRight();
	}
