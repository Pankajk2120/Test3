...
public class DragDropTypes   extends BaseTest {
    ...
    public void testElectricalPermit() {
        ...
        DragDropDemo DragDropDemo = new DragDropDemo(driver, test);
        PageFactory.initElements(driver, DragDropDemo);
        
        DragDropTypesDemo DragDropTypesDemo = new DragDropTypesDemo(driver, test);
        PageFactory.initElements(driver, DragDropTypesDemo);
        
        test.log(Status.INFO, "Selenium Using Java");
        
        DragDropTypesDemo.RedirectToDragAndDropPage1();
        DragDropTypesDemo.SimpleDragDrop();        
